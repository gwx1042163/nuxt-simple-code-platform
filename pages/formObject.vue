<template>
  <div>
    ...
    <div class="flex justify-center h-[100vh]">
      <el-menu :class="!isCollapse ? 'w-[200px]' : 'w-[60px]'" default-active="2" :collapse="isCollapse">
        <img class="collapseImg" src="imgs/icons/icon-菜单.png" alt="菜单" @click="isCollapse = !isCollapse" />
